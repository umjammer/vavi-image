...
import vavi.awt.image.pi.RetroPi;
 ...
 */
public class PiImageReader extends ImageReader {

    private static final Logger logger = getLogger(PiImageReader.class.getName());
    ...
    /** */
    public PiImageReader(ImageReaderSpi originatingProvider) {
